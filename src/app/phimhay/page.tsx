            ...
            <div className="border-[#fff2] border-[1px] rounded-[16px]">
               ...
               <div className="flex">
                  <div className="border-r-[1px] border-r-[#fff2] px-[32px] py-[24px] w-[420px]">
                     ...
                     <div className="">
                        {ListMovie.ListMovie.slice(0, 5).map((item, index) => (<CardMovieTrend id={index} Movie={item} />))}
                        <button className="text-[#fff5] cursor-pointer text-[12px] hover:text-[#f0d25c]">Xem thêm</button>
                     </div>
                  </div>
                                       <div className="border-r-[1px] border-r-[#fff2] px-[32px] py-[24px] w-[420px]">
                        <div className="flex pb-[24px] items-center">
                        ...
                        <div className="">
                           {ListMovie.ListMovie.slice(4,9).map((item, index)=>(<CardMovieTrend id={index} Movie={item}/>))}
                           <button className="text-[#fff5] cursor-pointer text-[12px] hover:text-[#f0d25c]">Xem thêm</button>
                        </div>
                     </div>
               </div>
